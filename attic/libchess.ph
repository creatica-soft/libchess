...
# 1 "libchess.h" 2
# 25 "libchess.h"
# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/16/include/stdbool.h" 1 3
# 26 "libchess.h" 2
# 39 "libchess.h"
...
static unsigned long bitFiles[] = {0x0101010101010101UL, 0x0202020202020202UL, 0x0404040404040404UL, 0x0808080808080808UL, 0x1010101010101010UL, 0x2020202020202020UL, 0x4040404040404040UL, 0x8080808080808080UL};
static unsigned long bitRanks[] = {0x00000000000000FFUL, 0x000000000000FF00UL, 0x0000000000FF0000UL, 0x00000000FF000000UL, 0x000000FF00000000UL, 0x0000FF0000000000UL, 0x00FF000000000000UL, 0xFF00000000000000UL};
...
static float pieceValue[] = { 0.0, 0.1, 0.30, 0.32, 0.50, 0.90, 1.0 };
static float pieceMobility[] = { 0.0, 4.0, 8.0, 11.0, 14.0, 25.0, 8.0 };
...
struct Engine {
 ...
 struct OptionCheck optionCheck[16];
 struct OptionCombo optionCombo[4];
 struct OptionSpin optionSpin[16];
 struct OptionString optionString[8];
 struct OptionButton optionButton[4];
 char engineName[255];
...
struct Board {
 unsigned long long defendedPieces;
 unsigned long long attackedPieces;
 unsigned long long attackedSquares;
 ...
 unsigned long long channel[64];
 unsigned long long sourceSquare[10];
...
# 1427 "libchess.h"
typedef char Tag[22][90];

typedef char EcoTag[3][90];
...
int generateEndGames(int maxGameNumber, int maxPieceNumber, char * dataset, char * engine, long movetime, int depth, int hashSize, int threadNumber, char * syzygyPath, int multiPV, _Bool logging, _Bool writedebug, int threads);
...
unsigned long openGamesFromPGNfile(char * fileName, int gameThreads, int sqlThreads, char * ecoFileName, int minElo, int maxEloDiff, int minMoves, int numberOfGames, _Bool generateZobristHash, _Bool updateDb, _Bool createDataset, char * dataset, _Bool eval, char * engine, long movetime, int depth, int hashSize, int engineThreads, char * syzygyPath, int multiPV, _Bool logging);
# 1595 "libchess.h"
unsigned long openGamesFromPGNfiles(char * fileNames[], int numberOfFiles, int gameThreads, int sqlThreads, char * ecoFileName, int minElo, int numberOfGames, int maxEloDiff, int minMoves, _Bool generateZobristHash, _Bool updateDb, _Bool createDataset, char * dataset, _Bool eval, char * engine, long movetime, int depth, int hashSize, int engineThreads, char * syzygyPath, int multiPV, _Bool logging);
...
void writeDebug(struct Board *, _Bool);
# 1643 "libchess.h"
...
struct Engine * initChessEngine(char * engineName, long movetime, int depth, int hashSize, int threadNumber, char * syzygyPath, int multiPV, _Bool logging);
...
_Bool isReady(struct Engine *);
_Bool newGame(struct Engine *);
void stop(struct Engine *);
void quit(struct Engine *);
_Bool position(struct Engine *);
