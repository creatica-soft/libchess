//c++ -O3 -I /opt/anaconda3/include -I /opt/anaconda3/include/torch/csrc/api/include -L /opt/anaconda3/lib -L /Users/ap/libchess -std=c++17 -Wl,-ltorch,-ltorch_cpu,-lc10,-lchess,-rpath,/opt/anaconda3/lib,-rpath,/Users/ap/libchess -o chess_cnn train_chess_cnn.cpp chess_cnn.cpp
//c++ -O3 -I /Users/ap/Downloads/libtorch/include -I /Users/ap/Downloads/libtorch/include/torch/csrc/api/include -L /Users/ap/Downloads/libtorch/lib -L /Users/ap/libchess -std=c++17 -Wl,-ltorch,-ltorch_cpu,-lc10,-lchess,-rpath,/Users/ap/Downloads/libtorch/lib,-rpath,/Users/ap/libchess -o chess_cnn train_chess_cnn.cpp chess_cnn.cpp
#include "chess_cnn.h"
...
void consumer_train(TensorQueue& queue, ChessCNN& model, torch::optim::Optimizer& optimizer,
    ...
    while (true) {
        ...
        if (sleep_counter == 3) {
            std::cout << "Consumer: Tensor queue empty, exiting after 3 attempts" << std::endl;
            break;
        }
...
int main(int argc, char ** argv) {
    ...
    std::vector<std::string> train_files;// = {"/Users/ap/Downloads/Lichess Elite Database/lichess_elite_2015-10.pgn"};
    if (argc == 2) train_files.push_back(argv[1]);
